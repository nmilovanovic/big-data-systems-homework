...
def operation(rdd):
    ...
    map4 = rddCombined1.collectAsMap()
    map5 = rddCombined2.collectAsMap()
    map6 = rddCombined3.collectAsMap()
    map7 = rddCombined1.collectAsMap()
    map8 = rddCombined2.collectAsMap()
    map9 = rddCombined3.collectAsMap()
